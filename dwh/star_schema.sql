...
CREATE TABLE IF NOT EXISTS dim_manager (
  ...
  emp_code VARCHAR(4) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS dim_date (
  ...
  date_id VARCHAR(10) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS dim_client (
  ...
  pass_code VARCHAR(4) UNIQUE NOT NULL,
  firstname TEXT NOT NULL,
  lastname TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS dim_show_room (
  ...
  show_room_name VARCHAR(10) UNIQUE NOT NULL,
  city TEXT NOT NULL,
  street TEXT NOT NULL,
  building VARCHAR(5) NOT NULL,

  prev_tel INTEGER,
  cur_tel INTEGER NOT NULL,
  effect_date DATE NOT NULL
);

CREATE TABLE IF NOT EXISTS dim_storage (
  sk_storage SERIAL PRIMARY KEY,
  storage_id VARCHAR(10) UNIQUE NOT NULL,
  city TEXT NOT NULL,
  street TEXT NOT NULL,
  building VARCHAR(5) NOT NULL,
  tel INTEGER NOT NULL,
...
CREATE UNIQUE INDEX bk_employee_code
